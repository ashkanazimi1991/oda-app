...
{/* ................info................................ */}
       ...
       <div className='flex flex-row border-y-2'>
        ...
        <div className='flex flex-row justify-around items-center w-3/4'>
               <div className=' py-5'>
                <h1 className='text-black text-3xl '>parvin</h1>
           ...
           <h1 className='text-black text-xl md:text-3xl'>1398</h1>
        ...
        <div>
            ...
            {/* ...../modal........... */}
            <div>
                <p className='text-black text-right leading-10 px-8 md:px-[20%] md:text-xl '>
                کارفرما :خانم سلیم پور 
                <br></br> <br></br>
آدرس پروژه :
آذربایجان غربی ، اورمیه ، شهرک بهداری خیابان محتشم خیابان پروین اعتصامی  
<br></br> <br></br>
زیربنا:
3000متر مربع در قالب 7 مسکونی در 9 طبقه
متریال مصرفی :
سازه بنا از اسکلت بتنی و متریال مصرفی نما سنگ تراورتن سفید ابیانه  و سنگ تراورتن سیلور دودی تکاب و سنگ تراورتن شکلاتی طرح چوب محلات.
                </p>
