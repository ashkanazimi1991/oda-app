...
export const Pezeshkian = () => {

  const images = [
    "/images/pezeshkian.jpg",
...
{/* ................info................................ */}
       ...
       <div className='flex flex-row border-y-2'>
        ...
        <div className='flex flex-row justify-around items-center w-3/4'>
               <div className=' py-5'>
                <h1 className='text-black text-3xl '>Pezeshkian</h1>
           ...
           <h1 className='text-black text-xl md:text-3xl'>1393</h1>
        ...
        <div>
            ...
            <div>
                <p className='text-black text-right leading-10 px-8 md:px-[20%]
                 md:text-xl '>
               کارفرما : شهرداری ارومیه <br></br> <br></br>
آدرس : ارومیه ، پزشکیان کاربری : تجاری مسکونی
                </p>
