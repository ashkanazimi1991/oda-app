...
const zoomInProperties = {
  ...
  return (
    <div className=' flex justify-center md:pl-[20%]  flex-col bg-[#ffffff] pt-12 
...
{/* ................info................................ */}
       ...
       <div className='flex flex-row border-y-2'>
        ...
        <div className='flex flex-row justify-around items-center w-3/4'>
               <div className=' py-5'>
                <h1 className='text-black text-3xl '>Amir</h1>
        ...
        <div>
            ...
            <div>
                <p className='text-black text-right leading-10 px-8 md:px-[20%]
                 md:text-xl '>
کارفرما :آقای فرهاد امام پور    
            <br></br>  <br></br> 
            آدرس پروژه :آذربایجان غربی ، اورمیه ، بلوار والفجر ، 16 متری اول
                <br></br>  <br></br> 
                زیربنا:13500متر مربع در قالب 6 واحد  مسکونی در 7 طبقه
                <br></br>  <br></br> 
                متریال مصرفی :سازه بنا از اسکلت بتنی و متریال مصرفی نما سنگ تراورتن کرم   و سنگ تراورتن شکلاتی تکاب و سنگ مرمریت نجف آباد.
                </p>
            </div>
        </div>
       </div>
