...
{/* ................info................................ */}
       ...
       <div className='flex flex-row border-y-2'>
        ...
        <div className='flex flex-row justify-around items-center w-3/4'>
               <div className=' py-5'>
                <h1 className='text-black text-3xl '>Khodkari</h1>
             
                
               </div>
               <div className='py-5'>
                <h1 className='text-black md:text-xl'>Iran - Chaloos</h1>
