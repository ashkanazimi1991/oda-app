...
{/* ................info................................ */}
       ...
       <div className='flex flex-row border-y-2'>
        ...
        <div className='flex flex-row justify-around items-center w-3/4'>
           ...
           <h1 className='text-black text-xl md:text-3xl'>1395</h1>
        ...
        <div>
            ...
            <div>
                <p className='text-black text-right leading-10 px-8 md:px-[20%]
                 md:text-xl '>
            کارفرما :آقای علیرضا جلیل زاده 
                <br></br>  <br></br> 
                آدرس پروژه :آذربایجان غربی ، اورمیه ، خیابان مدیریت ، کوچه  11 
                <br></br>  <br></br>  
                زیربنا:560 متر مربع در قالب دو واحد مسکونی در 4 طبقه
                <br></br>  <br></br>  
                متریال مصرفی :سازه بنا از اسکلت بتنی و متریال مصرفی نما سنگ تراورتن سفیدعباس آباد و سنگ ترامیت سفید اورمیه و سنگ سیلور دودی تکاب و سنگ ماسه ای طرح چوب .  
                </p>
